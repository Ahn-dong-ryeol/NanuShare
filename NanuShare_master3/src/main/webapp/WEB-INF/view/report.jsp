...
<td><input type="text" name="pwcheck"placeholder="제목을 작성해 주세요."/></td>
      ...
      <button type="button" data-icon="plus" onClick="getPictureFromCamera();">갤러리</button>
      </div>
      </fieldset>
      <a href=#><input type="submit" value="신고하기" data-role="button" data-iconpos="bottom"></a>
    ...
    <div data-role="popup" id="picturePopup">
      <a href="#pageone" data-rel="back" class="ui-btn ui-corner-all ui-shadow ui-btn-a ui-icon-delete ui-btn-icon-notext ui-btn-right">Close</a><img src="./resources/images/sample.jpg" style="width:400px;height:400px;">
    </div>
      ...
      <li onClick="getPictureFromCamera();">갤러리에서 가져오기</li>
