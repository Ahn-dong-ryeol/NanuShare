...
<h3>공지사항</h3>
<input type="text" name="pwcheck"placeholder="제목을 작성해 주세요."/>
      <textarea cols="50" rows="15" name="content" placeholder="내용을 작성해 주세요."></textarea>
    ...
    <div data-role="popup" id="picturePopup">
      ...
      <a href=#report1><input type="submit" value="게시하기" data-role="button" data-iconpos="bottom"></a>
