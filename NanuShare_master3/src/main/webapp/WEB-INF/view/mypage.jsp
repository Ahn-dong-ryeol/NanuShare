...
<div data-role="content">
  ...
  <div data-role="main" class="ui-content">
   ...
   <ul data-role="listview" data-inset="true">
      <li data-role="divider"><a href="#mypage2+">상세보기</a></li>
      <li>
      <table>
      <tr>
      <td rowspan="2" align="center"><a href="#mypage2+"><img src="./resources/images/sample.jpg" width="100px" height="100px"></a></td>
      <td><a href="#mypage2+">책 나눔합니다! 가져가세요</a></td>
      </tr>
      <tr>
      <td>배 송 중</td>
      </tr>
      ...
      <tr>
      <td rowspan="2" align="center"><a href="#mypage2+"><img src="./resources/images/sample.jpg" width="100px" height="100px"></a></td>
      <td><a href="#mypage2+">의자 가져가세요</a></td>
      </tr>
      <tr>
      <td>나 눔 진 행 중</td>
      </tr>
...
<div data-role="content">
  ...
  <div data-role="main" class="ui-content">
        <h4 align="center">전체 > 진행중 > 나눔마감 > 배송중 > 배송완료</h4>
   <ul data-role="listview" data-inset="true">
      <li data-role="divider"><a href="#mypage3+">상세보기</a></li>
      <li>
      <table>
      <tr>
      <td rowspan="2" align="center"><a href="#mypage3+"><img src="./resources/images/sample.jpg" width="100px" height="100px"></a></td>
      <td><a href="#mypage3+">책 나눔합니다! 가져가세요</a></td>
      </tr>
      <tr>
      <td>4 / 7 신 청 함</td>
      </tr>
      ...
      <tr>
      <td rowspan="2" align="center"><a href="#mypage3+"><img src="./resources/images/sample.jpg" width="100px" height="100px"></a></td>
      <td><a href="#mypage3+">의자 가져가세요</a></td>
      </tr>
      <tr>
      <td>배 송 완 료</td>
      </tr>
...
<div data-role="content">
  ...
  <table>
      ...
      <td><a href="#" class="ui-btn ui-btn-inline ui-mini ui-btn-b ui-corner-all">입력</a>
      <a href="#" class="ui-btn ui-btn-inline ui-mini ui-btn-b ui-corner-all">수정</a></td>
      </table>
      </li>
      </ul>
  </div><!-- main끝  -->
