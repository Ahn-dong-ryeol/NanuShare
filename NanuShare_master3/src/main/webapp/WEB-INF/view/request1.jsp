...
<div data-role="page" id="request1">
...
<ul data-role="listview" data-inset="true">
      ...
      <tr>
      <td colspan="3">문의 분류가 들어갑니다</td>
      </tr>
      <tr>
      <td colspan="2"><a href="#report3">제목이 들어갑니다</a></td>
      <td rowspan="2"><a href="#" class="ui-btn ui-btn-inline ui-mini ui-btn-b ui-corner-all">미답변</a></td>
      </tr>
      <tr>
      <td>작성자:누구누구</td>
      <td>작성시간이 들어가죠</td>
      ...
      <tr>
      <td colspan="2"><a href="#report3">제목이 들어갑니다</a></td>
      <td rowspan="2"><a href="#" class="ui-btn ui-btn-inline ui-mini ui-btn-b ui-corner-all">답변완료</a></td>
      </tr>
      <tr>
      <td>작성자:누구누구</td>
      <td>작성시간이 들어가죠</td>
      ...
      <a href=#report2><input type="submit" value="문의하기" data-role="button" data-iconpos="bottom"></a>
</div><!-- content끝 -->
